      ...
      <div className="bg-white shadow-sm border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <button className="bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white px-6 py-3 rounded-lg font-medium shadow-lg transform hover:scale-105 transition-all duration-200">
              Browse Products
            </button>
          </div>
        </div>
          ...
          <div className="p-6">
            {orders.length === 0 ? (
              <div className="text-center py-12">
                ...
                <button className="mt-6 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white px-6 py-3 rounded-lg font-medium shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
                  Browse Products
                </button>
              </div>
            ) : (
                        ...
                        {order.items.map((item: any) => (
                          <div key={item.id} className="flex items-center justify-between bg-slate-50 rounded-lg p-4">
                            ...
                            <div className="text-right">
                              ...
                              <p className="text-xs text-slate-600">${item.price / item.quantity} each</p>
                            </div>
                          </div>
                        ))}
                      </div>
